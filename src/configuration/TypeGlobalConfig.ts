...
export type TypeRouterConfig<TypeRouterConfigData, RouterServiceConfigEndPointOptions> = {
    service: TypeServiceConfig<TypeRouterConfigData, RouterServiceConfigEndPointOptions>
};
...
export type TypeGlobalConfig<AppServiceNamespaceConfig,AppServiceConfigEndPointOptions,RouterServiceConfig,RouterServiceConfigEndPointOptions, I18nData,I18nLocales, I18nConvert> = {
